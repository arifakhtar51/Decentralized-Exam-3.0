 ...
 */
update_option('stellarwp_uplink_license_key_status_kadence-blocks-pro_' . $_SERVER['HTTP_HOST'], 'valid');
update_option('stellarwp_uplink_license_key_kadence-blocks-pro', '6FGPLASTRA89');
set_transient('kadence_blocks_pro_license_status_check', '6FGPLASTRA89_valid');
update_option('kadence_gutenberg_pro_activation', 'Activated');
add_action( 'plugins_loaded', function() {
	add_filter( 'pre_http_request', function( $pre, $args, $url ) {
		if ( strpos( $url, 'https://licensing.stellarwp.com/api/plugins/v2/license/validate' ) !== false ) {
			return [
				'response' => [ 'code' => 200, 'message' => 'ОК' ],
				'body'     => json_encode( [ 'api_message' => 'Your license key is valid' ] )
			];
		}
